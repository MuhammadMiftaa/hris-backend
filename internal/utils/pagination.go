...
var AllowedSortColumns = map[string]map[string]string{
	"attendance": {
		...
		"clock_in_method": "al.clock_in_method",
		"department":      "d.name",
	...
	"leave_balances": {
		...
		"department_id":      "d.name",
		"leave_type":         "t.name",
		"leave_type_id":      "t.name",
		"year":               "b.year",
		"used_duration":      "b.used_duration",
		"max_duration":       "t.max_total_duration_per_year",
	...
	"leave_type": {
		...
		"max_duration_per_request":    "lt.max_duration_per_request",
	...
	"overtime": {
		...
		"work_location_type": "o.work_location_type",
		"reason":             "o.reason",
